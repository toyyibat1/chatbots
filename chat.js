// These are words the user may type in
...
const userWord = [
  ...
  // These are bot responses, paired in order with the above 'userWord' phrases
  ...
  // This is a small set of basically random 'catch alls' for anything that the user enters outside of the possible userWord phrases
  ...
  function addChat(input, product) {
    ...
    botDiv.id = "bot";
    botDiv.innerHTML = `kareebaBOT: <span id="bot-response">${product}</span>`;
